...
class ProductAdmin(admin.ModelAdmin):
    ...
    search_fields = ["title", "id_number", "description", "agent__registration_code", "agent__full_name"]
    ordering = ["-created_at"]
    ...
    def agent_registration_code(self, obj):
        if not obj.agent:
            return "-"
        return obj.agent.registration_code or "-"
